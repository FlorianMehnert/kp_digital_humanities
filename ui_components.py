    ...
    with st.sidebar:
        ...
        if advanced_settings:
            with st.expander("**LLM Parameters**"):
                a = st.toggle("Make output visible", value=False)
                st.session_state.show_system_prompt = a
                st.session_state.show_user_message = a
                st.session_state.show_assistant_message = a
